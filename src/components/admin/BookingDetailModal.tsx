          ...
          <div>
            ...
            <div className="bg-muted/50 rounded-lg p-4 space-y-3">
              <div className="flex justify-between">
                ...
                <span className="font-medium">${space?.basePrice.toLocaleString()}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">GST (8%)</span>
                <span className="font-medium">${((space?.basePrice || 0) * 0.08).toLocaleString()}</span>
              </div>
              <Separator />
              <div className="flex justify-between text-lg">
                <span className="font-medium text-foreground">Total</span>
                <span className="font-serif text-gold">
                  ${((space?.basePrice || 0) * 1.08).toLocaleString()}
                </span>
              </div>
            </div>
          </div>
